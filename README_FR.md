...
| 🧠 **AI core** | **Modèle hybride** (composante de tendances linéaires Ridge + LightGBM) : nowcast du **pic de température 6 heures à l'avance** par point — **Cotonou : MAE 0,26 °C, R² 0,95** · **Phoenix : MAE 0,36 °C, R² 0,98** (hold-out 24 h, ~2 Mo). + **z-score 48 h** (simple, seuil \|z\| ≥ 2,5) : anomalies — micro-pics locaux, dérives capteur |
...
- **Évaluation** : hold-out **temporel** 24 h (aucun leakage : les features
  ...
  MAE 0,36 °C · R² 0,98** (le désert est plus difficile : amplitude diurne
